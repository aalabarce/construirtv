...
<head>
  ...
  <link rel="shortcut icon" href="theme/images/favicon-blanco.ico">
  <title>:: Construir TV ::</title>
  ...
  <link rel="stylesheet" type="text/css" href="css/martin-styles.css" media="all" /> <!-- llamado a MARTIN STYLES -->
      ...
      <div class="row">
        <div class="col-lg-4 col-md-3 col-sm-3 col-xs-12 logoHeader">
          <a class="navbar-brand" href="http://www.bloodwindow.com/">
            <img class="img-responsive" ng-src="theme/images/logo.png" alt="" />
          </a>
        </div>
    ...
    <section class="main-cont">
      ...
      <div ng-controller="languageCtrl" class="idioma col-lg-12 col-md-12 col-sm-12 col-xs-12 hidden-sm hidden-xs">
        <div class="cerrar-login pull-left">
          <p>{{userName}}
            <a ng-show="language == 'eng'" href="{{serverURL}}/logout">Exit</a>
            <a ng-show="language == 'esp'" href="{{serverURL}}/logout">Cerrar</a>
          </p>
        </div>
        <a class="ico-en pull-right" ng-click="setLanguage('eng')"><img class="img-responsive" ng-src="theme/images/ico-uk.png" alt="" /></a>
        <a class="ico-es pull-right" ng-click="setLanguage('esp')"><img class="img-responsive" ng-src="theme/images/ico-spain.png" alt="" /></a>
      </div>
      <div class="clearfix"></div>
    ...
    <footer class="navbar navbar-default redes" ng-controller="SidebarCtrl">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center ventana-sur">
        <a href="http://www.ventanasur.gov.ar/">
          <img class="img-responsive" ng-src="theme/images/logo-ventana-sur.png" alt="" />
        </a>
      </div>
      -->
      <div class="clearfix"></div>
